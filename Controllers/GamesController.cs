...
namespace RelationsNaN.Controllers
{
    public class GamesController : Controller
    {
        ...
        public async void AddPlatform(int Id ,Platform platform)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult RemovePlatform()
        {
            ViewData["GenreId"] = new SelectList(_context.Genre, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Image,ReleaseYear,GenreId")] Game game)
        {
            ...
            ViewData["GenreId"] = new SelectList(_context.Genre, "Name", "Name", game.Name);
            return View(game);
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            platform = _context.Platform.ToList();
            if (game.Platforms != null)
            {
                platform = platform.Concat(game.Platforms).GroupBy(p => p.Id)
            .Where(g => g.Count() == 1)
            .Select(g => g.First())
            .ToList();
            }
            ...
            ViewData["Platforms"] = new SelectList(platform, "Platforms", "Platforms", game.Platforms);
            return View(game);
        }
